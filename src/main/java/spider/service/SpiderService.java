...
public class SpiderService {
	...
	public List<ChartsEntity> ChartsSpider(){
		...
		this.spiderBySingle(it, chartsEntityList);
		long endTime_1 = System.currentTimeMillis();
		logger.debug("单线程版本用时：" + (endTime_1 - startTime_1));
		
		long startTime_2 = System.currentTimeMillis();
		this.spiderControlByCountDownLatch(it, chartsEntityList);
		long endTime_2 = System.currentTimeMillis();
		logger.debug("多线程版本用时：" + (endTime_2 - startTime_2));
	 ...
	 */
	public void spiderBySingle(Iterator<Element> it,List<ChartsEntity> chartsEntityList){
		while(it.hasNext()){
	 ...
	 * @param chartsEntityList
	 */
	public void spiderControlByCountDownLatch(Iterator<Element> it,List<ChartsEntity> chartsEntityList){
		while(it.hasNext()){
			Element element = it.next();
			if(checkRegular(element)){
				ChartsEntity entity = new  ChartsEntity();
